        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center px-10">
            <div className="md:w-2/3 mb-10 md:mb-0">
              ...
              <a href="#servicios" className="py-3 bg-teal-600 hover:bg-teal-700 text-white font-bold px-4 rounded cursor-pointer transition-all duration-1000">
                Conoce nuestros Servicios
              </a>
            </div>
            <div className="md:w-1/3">
            <Image src="/image-home.png" alt="logo" width={1000} height={1000} className='w-auto  h-100 '/>
            </div>
          </div>
        </div>
      </section>
